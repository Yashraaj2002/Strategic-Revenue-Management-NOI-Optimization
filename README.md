...
## 📊 Dashboard: Property Analysis & Insight 
<img width="1408" height="820" alt="image" src="https://github.com/user-attachments/assets/22aa8b1d-fe67-4014-a5e5-bbd1a2ab6be8" />
💡 Displays key real estate KPIs (Occupancy %, Vacancy %, Loss-to-Lease, Avg PSF), with property-wise breakdowns and monthly lease-expiry trends.
